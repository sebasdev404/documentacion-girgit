---
titulo: Índice de Lógica del Negocio
modulo: indice
tipo: referencia
estado: borrador
tags: [moc, indice]
...
# Índice — Lógica del Negocio (SaaS de Gestión Escolar)
...
- [[01-vision-y-alcance/propuesta-de-valor|Propuesta de valor]]
- [[01-vision-y-alcance/mercado-objetivo|Mercado objetivo]]
- [[01-vision-y-alcance/alcance-y-no-alcance|Alcance y no-alcance]]
- [[01-vision-y-alcance/glosario|Glosario]]

## 02 — Usuarios, roles y permisos

- [[02-usuarios-roles-y-permisos/tipos-de-usuario|Tipos de usuario]]
- [[02-usuarios-roles-y-permisos/roles|Roles]] — índice de la subcarpeta
- [[02-usuarios-roles-y-permisos/matriz-de-permisos|Matriz de permisos]]
- [[02-usuarios-roles-y-permisos/reglas-transversales-de-roles|Reglas transversales de roles]]
...
- [[02-usuarios-roles-y-permisos/roles/00-superadministrador-plataforma|Superadministrador de la Plataforma]]
...
- [[02-usuarios-roles-y-permisos/roles/03-coordinador-convivencia|Coordinador de Convivencia]]
- [[02-usuarios-roles-y-permisos/roles/04-coordinador-academico-y-convivencia|Coordinador combinado]]
...
- [[03-multi-tenancy/modelo-de-tenants|Modelo de tenants]]
...
- [[03-multi-tenancy/jerarquia-organizacional|Jerarquía organizacional]]
...
- [[06-monetizacion-y-pagos/modelo-de-negocio|Modelo de negocio]]
- [[06-monetizacion-y-pagos/planes-y-suscripciones|Planes y suscripciones]]
...
- [[07-reglas-de-negocio/reglas-globales|Reglas globales]]
- [[07-reglas-de-negocio/reglas-por-modulo|Reglas por módulo]]
- [[07-reglas-de-negocio/validaciones|Validaciones]]
- [[07-reglas-de-negocio/estados-y-transiciones|Estados y transiciones]]

## 08 — Casos de uso

- [[08-casos-de-uso/README|Índice de casos de uso]]

## 09 — Reportes y analítica

- [[09-reportes-y-analitica/reportes-academicos|Reportes académicos]]
- [[09-reportes-y-analitica/reportes-financieros|Reportes financieros]]
- [[09-reportes-y-analitica/indicadores-kpi|Indicadores KPI]]
...
- [[_plantillas/plantilla-caso-de-uso|Plantilla — Caso de uso]]
- [[_plantillas/plantilla-regla-de-negocio|Plantilla — Regla de negocio]]
- [[_plantillas/plantilla-proceso|Plantilla — Proceso]]
- [[_plantillas/plantilla-rol|Plantilla — Rol]]
